        ...
        do {
            ...
            return projectEntities.map { projectEntity in
                Project(
                    ...
                    name: projectEntity.name ?? "Untitled",
                    projectDescription: projectEntity.projectDescription ?? "",
                    priority: projectEntity.priority ?? "Medium",
                    status: projectEntity.status ?? "Not Started",
                    budget: projectEntity.budget,
                    location: projectEntity.location ?? "Unknown",
                    startDate: projectEntity.startDate ?? Date(),
                    expectedEndDate: projectEntity.expectedEndDate ?? Date(),
                    createdAt: projectEntity.createdAt ?? Date(),
